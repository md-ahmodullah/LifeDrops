          ...
          <div className="space-y-2">
            ...
            <div className="pt-4">
              <div className="flex items-center gap-5 text-gray-200">
                <a className="border border-red-200 rounded-md bg-red-800 backdrop-blur-md bg-opacity-30 p-2 shadow-md shadow-gray-300">
                  <svg
          ...
          <div>
            ...
            <div className="border border-red-200 rounded-md bg-red-200 backdrop-blur-md bg-opacity-10">
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <button className="w-full btn btn-error text-white font-bold">
                    Send Message
                  </button>
                </div>
              </div>
